...
print("\nГаусове ядро (RBF):")
print(f"Акуратність: {accuracy_score(y_test, y_pred_rbf) * 100:.2f}%")
print(f"Точність: {precision_score(y_test, y_pred_rbf) * 100:.2f}%")
print(f"Повнота: {recall_score(y_test, y_pred_rbf) * 100:.2f}%")
print(f"Результат F1: {f1_score(y_test, y_pred_rbf) * 100:.2f}%")